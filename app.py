    ...
    for row in c.fetchall():
        ...
        try:
            ...
            if r.status_code == 200:
                data = r.json()
                hz_ledger = data.get('ingest_latest_ledger', 0)
...
def create_node():
    ...
    try:
        ...
        secret_seed = "SDZ7QXYM6VOMZV5BDBYV3RUXPQZQ2CPOX3S3Q3XQ3XQ3XQ3XQ3XQ3XQ3"
            ...
            for row in monitored_nodes:
                ...
                if not is_up:
                    ...
                    try:
                        ...
                        try:
                            subprocess.run(['docker', 'compose', 'restart'], cwd=node_path)
                        except:
                            pass
        except Exception as e:
